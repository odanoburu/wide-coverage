...
TranslatePor.pgf:: ; $(GFMKT) -name=TranslatePor translator/TranslatePor.gf +RTS -K64M
...
TranslateEngPor: TranslateEng.pgf TranslatePor
	$(GFMKT) -name=TranslateEngPor TranslateEng.pgf TranslatePor.pgf
